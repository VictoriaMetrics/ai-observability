...
```sh
git clone https://github.com/VictoriaMetrics/ai-observability
cd ai-observability
```
...
Once the observability stack is up, let's prepare environment for Python application:
```sh
python3 -m venv .venv  # create virtual environment
.venv/bin/pip install openlit # install openlit SDK
```
